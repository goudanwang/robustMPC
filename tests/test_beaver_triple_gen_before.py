...
from honeybadgermpc.hbavss_kzg_triples import Hbacss0, Hbacss1, Hbacss2
...
async def test_hbacss1_kzg(test_router):
    ...
    print("vm_matrix0", vm_matrix[0])
    print("vm_matrix1", vm_matrix[1])
    print("vm_matrix2", vm_matrix[2])
