...
class Hbacss0:
    ...
    async def _handle_implication(self, tag, j, j_sk):
        ...
        """
        print(self.my_id, "start _handle_implication")
    ...
    async def _process_avss_msg(self, avss_id, dealer_id, rbc_msg, avid):
        ...
        while True:
            ...
            print(sender, "sends", avss_msg[0], " type msg to", self.my_id)
            ...
            if avss_msg[0] in [HbAVSSMessageType.KDIBROADCAST, HbAVSSMessageType.RECOVERY1, HbAVSSMessageType.RECOVERY2]:
                #print("test", self.my_id, self.tagvars[tag]['all_shares_valid'])
    ...
    def _get_dealer_msg(self, values, n):
        ...
        witnesses = self.poly_commit.double_batch_create_witness(phi, r, n)
        for i in range(n):
